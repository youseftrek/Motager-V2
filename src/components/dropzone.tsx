...
const DropzoneContent = ({ className }: { className?: string }) => {
  const { files, setFiles, loading, successes, errors, maxFileSize, maxFiles } =
    useDropzoneContext();
  ...
  // Show success message only if there are files and all have been successfully uploaded
...
const DropzoneEmptyState = ({ className }: { className?: string }) => {
  const { maxFiles, maxFileSize, inputRef, files, loading } =
    useDropzoneContext();

  // Don't show empty state if files are being uploaded
