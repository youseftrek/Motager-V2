    ...
    <div className="min-h-screen text-white">
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <Input
                      ...
                      className=" border-gray-700 text-white placeholder-gray-400 focus:border-primary focus:ring-primary"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={handleInputChange}
                      rows={6}
                      className=" border-gray-700 text-white placeholder-gray-400 focus:border-primary focus:ring-primary resize-none"
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-emerald-500 hover:bg-emerald-600 text-black font-semibold py-3 transition-colors"
                  >
            ...
            <div className="space-y-8">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 mb-2">Speak with our team directly</p>
                      <a href="tel:+201234567890" className="text-primary hover:text-emerald-300 transition-colors">
                        +20 123 456 7890
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 mb-2">Come see us in person</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-primary space-y-1">
                        ...
                        <p className="text-gray-400 text-sm">(Cairo Time - GMT+2)</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-gradient-to-r from-amber-900/20 to-emerald-900/20 border-amber-700/30">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <h3 className="font-semibold text-amber-400">Built in Egypt</h3>
                  </div>
      ...
      <footer className="border-t border-gray-800 py-8 px-4 mt-16">
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} Motager. Where Your Store Comes to Life.</p>
        </div>
      </footer>
    </div>
  )
