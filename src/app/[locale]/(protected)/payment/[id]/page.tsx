...
export default function PaymentPage({ params }: any) {
  ...
  const planDetails = {
    free: {
      ...
      features: ["Up to 1 store", "Basic analytics", "24/7 support", "Mobile optimization"],
      color: "bg-gray-600",
      popular: false,
    },
    basic: {
      ...
      features: ["Up to 2 stores", "Basic analytics", "24/7 support", "Mobile optimization"],
      color: "bg-blue-600",
      popular: false,
    },
    pro: {
      ...
      features: ["Up to 5 stores", "Advanced analytics", "24/7 support", "Mobile optimization", "Priority support"],
  ...
  const planId = Number.parseInt(params.id) || 2 // Default to basic plan (id: 2)
        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="mb-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-lg">Secure checkout powered by Tap Payments</p>
            </div>
          </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        <div className="flex items-start gap-3">
                          <div className={`w-3 h-3 rounded-full ${selectedPlan.color} mt-2`}></div>
                          <div>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-gray-400">{isAnnual ? "per year" : "per month"}</p>
                        </div>
                      </div>
                      ...
                      {isAnnual && savings > 0 && (
                        <div className="bg-emerald-900/20 border border-emerald-800/50 rounded-lg p-3">
                          <div className="flex items-center justify-between">
                            <span className="text-emerald-400 font-medium">Annual Discount (20%)</span>
                            <span className="text-emerald-400 font-semibold">-${savings.toFixed(2)}</span>
                          </div>
                        </div>
                      )}
              ...
              <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm shadow-2xl sticky top-4">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <div className={`w-3 h-3 rounded-full ${selectedPlan.color}`}></div>
                    {selectedPlan.name}
                  </CardTitle>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center p-4 bg-gray-800/30 rounded-lg border border-gray-700">
                    ...
                    <div className="text-gray-400 text-sm">{isAnnual ? "per year" : "per month"}</div>
                    {isAnnual && (
                      <div className="text-emerald-400 text-sm mt-1">Save ${savings.toFixed(2)} annually</div>
                    )}
                  </div>
                  ...
                  {/* Features List */}
                  <div>
                    <h4 className="font-semibold mb-3 text-gray-200">What's included:</h4>
